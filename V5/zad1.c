...
//https://www.susa.net/wordpress/2012/06/raspberry-pi-pcf8563-real-time-clock-rtc/
...
#define GOD 0x08
 ...
 unsigned char init8563_Store[6]={0x00,0x59,0x08,0x02,0x03,0x19};
 void P8563_settime()
{
 WriteBuf[0] = SEK;
...
void P8563_Readtime()
{
 ...
 g8563_Store[0] = time[0] & 0x7f; //6 bita
 g8563_Store[1] = time[1] & 0x7f; //6 bita
 g8563_Store[2] = time[2] & 0x3f;  //5 bita
 g8563_Store[3] = time[3] & 0x3f;
 g8563_Store[4] = time[4] & 0x1f;  //PITAJ OVAJ DEO !!!
 g8563_Store[5] = time[5] + 100;
...
// adresa PCF8563 na I2C magistrali
 ...
 {                                                                     //-100 i +1 ??
 P8563_Readtime();
 printf("Godina: %d Mesec: %d Dan: %d Sati:%d Minuti:%d Sekunde:%d\n", g8563_Store[5]-100, g8563_Store[4]+1, g8563_Store[2], g8563_Store[1], g8563_Store[0]);
 bcm2835_delay(5000);
}
